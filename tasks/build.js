...
var copyAngular = function () {
    return projectDir.copyAsync('browser', destDir.path(), {
        overwrite: true,
        matching: paths.toCopyAngular
    });
};


gulp.task('copy', ['clean'], copyTask);
gulp.task('copy-angular', copyAngular);
...
gulp.task('build', ['transpile', 'copy', 'copy-angular', 'finalize']);
